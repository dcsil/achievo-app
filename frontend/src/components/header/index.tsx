...
const Header: React.FC<HeaderProps> = ({ user }) => {
  ...
  return (
    <header className="w-full bg-gradient-to-br from-rose-100 via-amber-50 to-amber-100 py-4 px-5 shadow-sm rounded-2xl relative">
      <div className="flex flex-col min-[500px]:flex-row min-[500px]:items-center gap-4 max-w-6xl mx-auto relative z-10">
        {/* Top row on mobile: Profile Picture + Coin Counter + Notification */}
        <div className="flex items-center justify-between min-[500px]:contents">
          {/* Profile Picture */}
          ...
          {/* Coin Counter and Notification Container - side by side on mobile, original layout on desktop */}
          <div className="flex items-center gap-3 min-[500px]:ml-auto">
            {/* Coin Counter */}
        ...
        {/* Welcome Message and Quote - moves below on mobile */}
        <div className="flex-1 min-w-0 min-[500px]:order-first min-[500px]:mx-4">
